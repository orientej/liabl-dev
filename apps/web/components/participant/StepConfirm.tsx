...
interface Props { answers:ParticipantAnswers; labels:Record<string,string>; onRestart:()=>void; restartLabel?:string }
export default function StepConfirm({ answers, labels, onRestart, restartLabel }: Props) {
